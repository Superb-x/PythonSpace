...
serarr = list("$@B%8&WM#*oahkbdpqwmZO0QLCJUYXzcvunxrjft/\|()1{}[]?-_+~<>i!lI;:,\"^`'. ")
count = len(serarr)
...
image_file = Image.open("ljl.dat")  # 打开图片
image_file = image_file.resize((int(image_file.size[0] * 0.09), int(image_file.size[1] * 0.05)))  # 调整图片大小
